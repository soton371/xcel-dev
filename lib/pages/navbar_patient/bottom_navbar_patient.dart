...
class BottomNavBarPatient extends StatefulWidget {
  final int switchTabIndex;
  const BottomNavBarPatient({super.key, this.switchTabIndex = 0});
...
class BottomNavBarPatientState extends State<BottomNavBarPatient> {
  ...
  List<Widget> pages = [
    const HomePage(),
    const AppointmentPage(initialIndex: 1),
    const RequestPage(),
        ...
        bottomNavigationBar: FlipBoxNavigationBar(
          ...
          items: <FlipBoxNavigationBarItem>[
            FlipBoxNavigationBarItem(
              ...
              selectedBackgroundColor: Colors.deepPurpleAccent[200] ?? Colors.deepPurpleAccent,
              unselectedBackgroundColor: Colors.deepPurpleAccent[100] ?? Colors.deepPurpleAccent,
            ),
            ...
            FlipBoxNavigationBarItem(
              ...
              selectedBackgroundColor: Colors.greenAccent[200] ?? Colors.greenAccent,
              unselectedBackgroundColor: Colors.greenAccent[100] ?? Colors.greenAccent,
            ),
            FlipBoxNavigationBarItem(
              name: 'Requests',
              selectedIcon: Icons.assignment,
              unselectedIcon: Icons.assessment_outlined,
              selectedBackgroundColor: Colors.redAccent[200] ?? Colors.redAccent,
              unselectedBackgroundColor: Colors.redAccent[100] ?? Colors.redAccent,
            ),
            FlipBoxNavigationBarItem(
              name: 'Prescription',
              selectedIcon: CupertinoIcons.time_solid,
              unselectedIcon: CupertinoIcons.time,
              selectedBackgroundColor: Colors.orangeAccent[200] ?? Colors.orangeAccent,
              unselectedBackgroundColor: Colors.orangeAccent[100] ?? Colors.orangeAccent,
            ),
            FlipBoxNavigationBarItem(
              name: 'Settings',
              ...
              unselectedBackgroundColor: Colors.blueGrey[100] ?? Colors.blueGrey,
            ),
          ],
          onTap: (index) {
            setState(() {
