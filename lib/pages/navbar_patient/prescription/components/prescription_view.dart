                ...
                Row(
                  ...
                  children: [
                    (medReqFlag??0) > 0 || (data2?.patMedicine) == null || data2!.patMedicine!.isEmpty ? Container(
                      ...
                      child: Column(
                        children: [
                          const Text('Tap', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                          const SizedBox(height: 4),
                          Row(
                            children: [
                              const Column(
                                children: [
                                  Text('Request for', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                  Text('Delivery', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                ],
                              ),
                              const SizedBox(width: 5),
                              Image.asset('assets/images/arrow.png', height: 35, width: 35)
                            ],
                          ),
                        ],
                      ),
