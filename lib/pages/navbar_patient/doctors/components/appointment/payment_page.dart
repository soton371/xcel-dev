                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                CustomButton(btnColor: primaryColor, btnText: 'Submit', onTap: () {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            CustomButton(btnColor: primaryColor, btnText: 'Ok', onTap: ()=>Navigator.pop(context))
          ],
        );
      });
}
